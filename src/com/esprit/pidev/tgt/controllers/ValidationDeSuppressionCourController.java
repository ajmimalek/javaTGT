 ...
 * @author Nadhem
 */
public class ValidationDeSuppressionCourController implements Initializable {
    ...
    private void abendonner(ActionEvent event) {
     ...
     public void initfields(Cour cour, ListFormationController listFormationController){
    this.cour=cour;
     this.ListFormationController= listFormationController;
      
    }
public void initfieldss(Cour cour, ListFormation_1Controller listFormation_1Controller){
    this.cour=cour;
